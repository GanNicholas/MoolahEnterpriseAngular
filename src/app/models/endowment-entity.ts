...
export class EndowmentEntity extends ProductEntity {
    ...
    constructor(productId?: number, productEnum?: EndowmentProductEnum, productName?: string, coverageTerm?: number,
        ...
        super(productId, productName, coverageTerm, assuredSum, description, isDeleted, premiumTerm, currency, pricing, averageInterestRate, isAvailableToSmoker);
